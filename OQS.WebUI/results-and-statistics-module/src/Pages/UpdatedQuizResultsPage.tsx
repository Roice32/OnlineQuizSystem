...
const UpdatedQuizResultsPage = () => {
  const { userId, quizId } = useParams<{ userId: string, quizId: string }>();
  const [quizResults, setQuizResults] = useState<QuizResults | null>(null);
  const [loading, setLoading] = useState(true);

  const handleBackClick = () => {
    window.history.back(); ///trebuie sa te duca pe pagina profilului(de modficat) dupa integrare
  };
...
export default UpdatedQuizResultsPage;