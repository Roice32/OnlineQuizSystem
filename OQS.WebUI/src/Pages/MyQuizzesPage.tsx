...
import {faTrashAlt, faEdit, faChartLine} from '@fortawesome/free-solid-svg-icons';
                        ...
                        <div className="flex flex-col py-2 px-4">
                            ...
                            <div className="flex items-center">
                                ...
                                <div className="ml-auto">
                                    <Link className="bg-[#436e6f] text-white px-4 py-2 rounded mr-2"
                                          to={`/created-quiz-stats/${quiz.id}`}>
