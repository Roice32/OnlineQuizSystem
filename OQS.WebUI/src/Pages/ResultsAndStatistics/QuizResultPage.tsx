    ...
    <div className="min-h-screen bg-[#1c4e4f] flex flex-col items-center p-6 font-mono">
      <div className="w-full max-w-2xl bg-white shadow-lg rounded-lg p-6">
        ...
        <div className="grid grid-cols-3 gap-4 text-center p-4 rounded-3xl rounded-b-none border-4 border-solid border-gray-400">
          ...
          <p className="text-lg bg-gray-200 p-2 rounded-md">{quizResult?.quizResultHeader.reviewPending ? 'Review Pending' : 'Review Not Pending'}
          </p>
          <p className="col-span-4 text-lg bg-gray-200 p-2 rounded-md">Submitted at: {quizResult ? formatDate(quizResult.quizResultHeader.submittedAtUtc) : "Unknown"}</p>
        </div>
