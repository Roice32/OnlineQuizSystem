            ...
            case QuestionType.TrueFalse:
                ...
                return (
                    <>
                        ...
                        <RadioGroup.Root value={correctAnswerTrueFalse} name="trueFalse"
                                    ...
                                    <Flex direction="column" align="center">
                                        <Flex className="w-10/12 sm:w-96" direction="column">
                                            <Box mb="10px">
                                                ...
                                                <TextField.Root placeholder="Add a name..." value={quiz.name}
                                                                onChange={(event) => {
                                                ...
                                                {errorMessages.name &&
                                                    <Text as="p" color="red">{errorMessages.name}</Text>}
                                            </Box>
                                            <Box mb="10px">
                                                <Text as="label">Image URL</Text>
                                                <TextField.Root placeholder="Add a image url..." value={quiz.imageUrl}
                                                                onChange={(event) => {
                                                                    if (!event.target.value) {
                                                                        if (event.target.value === '') {
                                                                            setQuiz({
                                                ...
                                                {errorMessages.imageUrl &&
                                                    <Text as="p" color="red">{errorMessages.imageUrl}</Text>}
                                            </Box>
                                            <Box mb="10px">
                                                <Text as="label">Description</Text>
                                                <TextArea placeholder="Add a description..." value={quiz.description}
                                                          onChange={(event) => {
                                                              if (!event.target.value) {
                                                                  if (event.target.value === '') {
                                                                      setQuiz({
                                                ...
                                                {errorMessages.description &&
                                                    <Text as="p" color="red">{errorMessages.description}</Text>}
                                            </Box>
                                            <Flex mb="10px" direction="column">
                                                <Text as="label">Language</Text>
                                                <Select.Root defaultValue="romanian" value={quiz.language}
                                                             onValueChange={(value) => {
                                            ...
                                            <Box mb="10px">
                                                <Text as="label">Time limit</Text>
                                                <TextField.Root placeholder="Add a time limit..." value={quiz.timeLimit}
                                                                onChange={(event) => {
                                                ...
                                                {errorMessages.timeLimit &&
                                                    <Text as="p" color="red">{errorMessages.timeLimit}</Text>}
                                            </Box>
                                        </Flex>
                                    </Flex>
                                </Tabs.Content>
                                            ...
                                            <Button onClick={async () => {
                                                ...
                                                try {
                                                    ...
                                                    if (editPage) {
                                                        ...
                                                        response = await fetch('http://localhost:5276/api/quizzes', {
                                                            method: 'POST',
                                                            headers: {
                                                                'Content-Type': 'application/json',
                                                                'Authorization': `Bearer ${token}`
