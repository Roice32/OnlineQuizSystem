        ...
        <div className="container mx-auto p-6">
            ...
            {quizData ? (
                ...
                <div className="bg-[#0A2D2E] p-8 rounded-lg shadow-md text-white mt-10 flex-col flex">
                    <div
                        className="font-bold text-5xl capitalize mb-12 text-center p-4 text-[#DEAE9F]">{quizData.name}</div>
                    <div className="flex justify-center items-center">
                        <div className="w-1/2 pr-8">
                            <img
                                src={quizData.imageUrl || "https://www.shutterstock.com/shutterstock/photos/2052894734/display_1500/stock-vector-quiz-and-question-marks-trivia-night-quiz-symbol-neon-sign-night-online-game-with-questions-2052894734.jpg"}
                                alt="Quiz Image"
                        ...
                        <div className="w-1/2 pl-8 text-center">
                            ...
                            <div className="mt-5">
                                <div className="font-bold text-3xl capitalize mb-2 text-[#DEAE9F]">Time Limit
                                    (Minutes):
                                </div>
                            ...
                            <div className="mt-5">
                                ...
                                <p className="text-lg">{new Date(quizData.createdAt || "2024-06-02T20:57:29.6568126").toLocaleString()}</p>
                            </div>
                            <div className="mt-10">
