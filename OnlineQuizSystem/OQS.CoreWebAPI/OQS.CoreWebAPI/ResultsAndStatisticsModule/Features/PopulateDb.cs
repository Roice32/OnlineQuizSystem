...
namespace OQS.CoreWebAPI.ResultsAndStatisticsModule.Features
{
        ...
        private static void SeedUsers(ApplicationDbContext dbContext)
        {
            var users = new List<User>
            {
                new User
                {
                    ...
                    Email = "galatanuemilia14@gmail.com"
                },
                new User
                {
                    ...
                    Name = "Name2",
                    Type = UserType.Admin,
                    Email = "denisa.golache@gmail.com"
                },
                new User
                {
    ...
    public class PopulateDb
    {
        ...
        public class Handler : IRequestHandler<Query, Result>
        {
            ...
            {
                Seeder.SeedDb(dbContext);
                return Result.Success();
            }
        }
    }

    public class PopulateDbEndPoint : ICarterModule
    {
        public void AddRoutes(IEndpointRouteBuilder app)
        {
            app.MapPost("/api/populateDb", async (ISender sender) =>
            {
                var query = new PopulateDb.Query();
