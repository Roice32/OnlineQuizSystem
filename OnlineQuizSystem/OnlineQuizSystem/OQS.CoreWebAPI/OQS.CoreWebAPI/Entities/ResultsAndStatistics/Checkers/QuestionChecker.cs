            ...
            var chatRequest = new ChatRequest
            {
                ...
                Messages = new[]
                {
                    ...
                    new ChatMessage(ChatMessageRole.User, "Question: " + question.Text +
                        ...
                        "\nPlease review and grade the answer based on the provided criteria, and return the response in the following JSON format: { \"review\" : \"textReview\", \"grade\" : floatValueBetween0AndMaxPossibleScore }")               
                },
                MaxTokens = 100,
                Temperature = 0.5f,
                TopP = 1
