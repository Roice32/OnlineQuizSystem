          ...
          {questions.map((question, index) => (
            <div key={question.id} className="flex flex-col mt-5">
              ...
              <input
                ...
                className="p-2 border border-gray-300 rounded-md"
              />
              <select value={question.type} onChange={(e) => handleQuestionTypeChange(index, e)}
              ...
              <button onClick={() => removeQuestion(question.id)}
                      className="mt-2 p-2 bg-red-500 text-white rounded-md">Remove Question
              </button>
            </div>
          ))}
        </div>
