...
namespace OQS.CoreWebAPI.ResultsAndStatisticsModule.Extensions
{
    ...
    {
        public static FetchQuizResultHeaderResponse FetchQuizResultHeader(this WebApplication application, Guid QuizId, Guid UserId)
        {
        ...
        public static FetchQuizResultHeaderResponse FetchQuizResultHeader(RSMApplicationDbContext dbContext, Guid QuizId, Guid UserId)
        {
